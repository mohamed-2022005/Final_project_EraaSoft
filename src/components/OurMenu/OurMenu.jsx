...
function                            OurMenu() {
    ...
    // --- Logic: Handle Smooth Scroll on Mount/Hash Change ---
    useEffect(() => {
        if (location.hash === "#menu-cards") {
            const element = document.getElementById('menu-cards');
            if (element) {
    ...
    return (
        <div className='bg-linear-to-br from-[#1a120b] via-[#2a1e14] to-[#3e2b1d] min-h-screen py-16 px-4 sm:px-6 lg:px-8'>
            <div className='max-w-7xl mx-auto'>
                ...
                {/* --- Full Menu Grid --- */}
                <div id="menu-cards" className='grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4'>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className='p-4 sm:p-6 flex flex-col grow'>
                                    <h3 className='text-xl sm:text-2xl mb-2 font-dacingscript text-amber-100 card-animate' style={{ '--index': i }}>
                                        {item.name}
                                    </h3>
                                    ...
                                    <div className='mt-auto flex items-center justify-between gap-4'>
                                        <div className='bg-amber-100/10 backdrop-blur-sm px-3 py-1 rounded-2xl shadow-lg'>
                                            <span className='text-xl font-bold text-amber-300 font-dacingscript card-animate' style={{ '--index': i }}>
                                                ₹{item.price}
                                            </span>
                                        </div>
