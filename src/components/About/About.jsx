...
function About() {
    const [hoverdStat, setHoverStat] = useState(null);

    return (
        <div className='min-h-screen bg-linear-to-br from-[#1a120b] via-[#3c2a21] to-[#1a120b] text-amber-50 overflow-hidden relative'>
            ...
            {/* --- Features Section --- */}
            <section className='py-12 px-4 md:px-4 relative'>
                <div className='max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-12'>
                    {features.map((f, i) => {
                        ...
                        return (
                            ...
                            >
                                <div className='absolute inset-0 bg-linear-to-br from-amber-600/30 to-amber-500/30 rounded-3xl blur-lg opacity-50 group-hover:opacity-80 transition-opacity duration-500' />
                                ...
                                <div className='relative bg-[#3c2a21]/90 backdrop-blur-lg rounded-3xl overflow-hidden border border-amber-600/30 hover:border-amber-500 transition-all duration-300 h-full'>
                                    ...
                                    <div className='p-8'>
                                        ...
                                        <h2 className='text-2xl font-bold mb-2 text-amber-100'>{f.title}</h2>
            ...
            {/* --- Stats Section --- */}
            <section className='p-16 px-4 md:px-8 bg-linear-to-br from-[#1a120b] to-[#3c2a21]/90'>
                    ...
                    {stats.map((s, i) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    <div className='relative h-full bg-[#3c2a21]/40 backdrop-blur-lg rounded-xl border-2 border-amber-600/30 p-6 overflow-hidden'>
                                        <motion.div
                                        ...
                                        <div className='relative z-10 h-full flex flex-col items-center justify-center'>
                                            <motion.div
                                                className='mb-4 p-3 rounded-full bg-amber-900/30 border border-amber-500/20'
                                            ...
                                            <motion.div
                                                className='text-amber-100/80 font-medium tracking-wide uppercase text-xs'
                                                animate={{
                                                    letterSpacing: hoverdStat === i ? '0.1em' : '0em',
                                                    textShadow: hoverdStat === i ? '0 0 8px rgba(245, 158, 11, 0.4)' : 'none'
                                                }}
                                            >
                                                {s.label}
                                            </motion.div>
                            ...
                            >
                                <div className='relative h-full bg-[#3c2a21]/90 backdrop-blur-lg rounded-3xl overflow-hidden border-2 border-amber-600/30 hover:border-amber-500 transition-all duration-500 shadow-xl hover:shadow-2xl hover:shadow-amber-500/20'>
                                    ...
                                    <div className='p-8 text-center flex flex-col h-[calc(100%-24rem)]'>
                                        ...
                                        <p className='text-amber-100/80 text-lg font-cursive grow'>
                                            {m.bio}
                                        </p>
                                        ...
                                        >
                                            {Object.entries(m.social).map(([platform, url]) => (
                                                ...
                                                >
                                                    {platform === 'twitter' && <FaXTwitter className='w-6 h-6' />}
                                                    {platform === 'instagram' && <FaInstagram className='w-6 h-6' />}
                                                    {platform === 'facebook' && <FaFacebookF className='w-6 h-6' />}
                                                    {platform === 'linkedin' && <FaLinkedinIn className='w-6 h-6' />}
                                                </a>
                                            ))}
                                        </motion.div>
                                    </div>
